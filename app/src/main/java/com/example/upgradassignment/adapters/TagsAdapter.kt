...
class TagsAdapter(tagList: ArrayList<Item>, _context: Context, val clickListener: (Item, Int) -> Unit) :
    androidx.recyclerview.widget.RecyclerView.Adapter<TagsAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.tagName?.setTextSize(1, 25f)
